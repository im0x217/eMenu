  ...
  <div class="favorites-view-container">
    ...
    <div v-else class="empty-state glass-panel">
      <div class="empty-icon-wrapper">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--primary-color)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="opacity: 0.7;" aria-hidden="true">
    ...
    <Teleport to="body">
      <Transition name="zoom-fade">
        <div v-if="zoomedImgUrl" class="zoom-backdrop" role="dialog" aria-modal="true" aria-label="عرض صورة المنتج المكبرة" @click="closeZoomModal">
